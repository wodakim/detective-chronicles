...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'interrogation.marcus.q2': 'Quelle était votre relation professionnelle avec Elias récemment ?',
    'interrogation.marcus.q2.opt1': 'Avez-vous eu des désaccords concernant son contrat ?',
    'interrogation.marcus.q2.opt1.resp': '*hésite* Elias voulait... rompre notre contrat. Il avait trouvé un autre agent. Mais je ne l\'ai pas tué pour ça !',
    'interrogation.marcus.q2.opt2': 'Votre collaboration se passait bien ?',
    'interrogation.marcus.q2.opt2.resp': 'Oui, tout allait bien. Nous travaillions ensemble depuis 5 ans. C\'était une relation professionnelle solide.',
    'interrogation.marcus.q2.opt3': 'Aviez-vous des intérêts financiers dans sa carrière ?',
    'interrogation.marcus.q2.opt3.resp': '*nerveux* Bien sûr, j\'étais son agent. Je touchais une commission. Mais de là à le tuer... vous délirez !',
    
    'interrogation.sarah.q1': 'Parlez-moi de votre relation avec Elias.',
    'interrogation.sarah.q1.opt1': 'Comment s\'est passée votre rupture ?',
    'interrogation.sarah.q1.opt1.resp': '*triste* C\'était difficile. Nous nous aimions, mais sa carrière passait avant tout. J\'ai fini par partir il y a six mois.',
    'interrogation.sarah.q1.opt2': 'Étiez-vous en colère contre lui ?',
    'interrogation.sarah.q1.opt2.resp': '*défensive* En colère ? Peut-être au début. Mais j\'avais tourné la page. Je ne lui voulais aucun mal.',
    'interrogation.sarah.q1.opt3': 'Lui avez-vous écrit récemment ?',
    'interrogation.sarah.q1.opt3.resp': '*baisse les yeux* Oui... je lui ai écrit une lettre. Pour lui dire que je lui pardonnais. Mais je ne sais pas s\'il l\'a lue.',
    'interrogation.sarah.q2': 'Où étiez-vous le soir de sa mort ?',
    'interrogation.sarah.q2.opt1': 'Étiez-vous chez vous ?',
    'interrogation.sarah.q2.opt1.resp': 'Oui, j\'étais seule chez moi. Je répétais un morceau de violon. Personne ne peut confirmer, malheureusement.',
    'interrogation.sarah.q2.opt2': 'Quelqu\'un peut-il confirmer votre alibi ?',
    'interrogation.sarah.q2.opt2.resp': '*embarrassée* Non... j\'étais seule. Mais je vous jure que je n\'ai rien fait. Pourquoi aurais-je tué l\'homme que j\'aimais ?',
    'interrogation.sarah.q2.opt3': 'Aviez-vous prévu de le voir ce soir-là ?',
    'interrogation.sarah.q2.opt3.resp': 'Non. Je ne l\'avais pas vu depuis notre rupture. C\'était trop douloureux.',
    
    'interrogation.aris.q1': 'En tant que frère et médecin, que pensez-vous de sa mort ?',
    'interrogation.aris.q1.opt1': 'Pensez-vous qu\'il aurait pu se suicider ?',
    'interrogation.aris.q1.opt1.resp': '*ému* Non. Elias n\'était pas dépressif. Il avait des projets, un voyage prévu en Italie. Il avait même modifié son testament récemment.',
    'interrogation.aris.q1.opt2': 'Aviez-vous accès à de la morphine ?',
    'interrogation.aris.q1.opt2.resp': '*sur la défensive* Je suis médecin, évidemment que j\'ai accès à des médicaments. Mais je n\'ai jamais donné de morphine à Elias !',
    'interrogation.aris.q1.opt3': 'Pourquoi aurait-on voulu le tuer ?',
    'interrogation.aris.q1.opt3.resp': '*en colère* C\'est ce que j\'essaie de comprendre ! Mon frère avait des ennemis, des gens jaloux de son succès. Marcus, son agent, était furieux de la rupture de contrat.',
    'interrogation.aris.q2': 'Quand avez-vous vu Elias pour la dernière fois ?',
    'interrogation.aris.q2.opt1': 'L\'avez-vous vu le jour de sa mort ?',
    'interrogation.aris.q2.opt1.resp': 'Non, je ne l\'ai pas vu ce jour-là. Nous devions dîner ensemble le lendemain. Il ne s\'est jamais présenté...',
    'interrogation.aris.q2.opt2': 'Vous a-t-il parlé de problèmes récents ?',
    'interrogation.aris.q2.opt2.resp': 'Il m\'a dit qu\'il voulait changer d\'agent. Marcus ne le prenait pas bien. Il y avait aussi Sarah qui lui avait écrit.',
    'interrogation.aris.q2.opt3': 'Étiez-vous proche de votre frère ?',
    'interrogation.aris.q2.opt3.resp': '*les larmes aux yeux* Très proche. C\'était mon petit frère. Je l\'ai toujours protégé. Et maintenant... il est parti.',
